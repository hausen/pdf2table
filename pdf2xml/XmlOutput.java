	  ...
	  try {
        ...
        String dtd_value = "<?xml version=\"1.0\" encoding=\"iso-8859-1\"?>\n" +
          ...
          ">\n";
            ...
            System.out
                    .println("Exception in class: XmlOutput and method: create_tables_dtd. "
                            + ie);
        } catch (Exception e) {
            System.out
                    .println("Exception in class: XmlOutput and method: create_tables_dtd. "
    ...
    public static void create_output(String path, List<Font> fonts,
        ...
        try {
            ...
            for (int km = 0; km < fonts.size(); km++) {
                Font f = fonts.get(km);
                ps.println("<fontspec id=\"" + f.id + "\" size=\"" + f.size
                        + "\" family=\"" + f.family + "\" color=\"" + f.color
                        + "\"/>");
            }
            ...
            for (int i = 0; i < tables.size(); i++) {
                ...
                // Mac version below
                // dos.println("<title>" + "TABLE ON PAGE " + c_table.page +
                // "</title>");
            ...
            System.out
                    .println("Exception in class: XmlOutput and method: create_output. "
                            + ie);
        } catch (Exception e) {
            System.out
                    .println("Exception in class: XmlOutput and method: create_output. "
